class CheckView:
    ...
    def user_entry(self, message_display,  message_error, value_type, default_value=None, user_entry=None):
        '''Création du classe qui permet de gérer les affichage des message et la vérification des informations saisi par l'utilisateur'''
